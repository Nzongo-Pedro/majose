<section class="hero">
    <div class="hero__slider owl-carousel">
        <div class="hero__items set-bg" data-setbg="{{asset('site/img/hero/hero-5.jpg')}}">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            <h6>Coleção Verão</h6>
                            <h2>Tendências Outono-Inverno</h2>
                            <p>Elegância atemporal para mulheres que valorizam sofisticação e consciência ambiental.</p>
                            <a href="#" class="primary-btn">Comprar agora <span class="arrow_right"></span></a>
                            <div class="hero__social">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
        ...
        <div class="hero__items set-bg" data-setbg="{{asset('site/img/hero/hero-2.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            <h6>Coleção Verão</h6>
                            <h2>Exclusivo Outono-Inverno</h2>
                            <p>Estilo contemporâneo com toque de luxo, pensado para todas as ocasiões.</p>
                            <a href="#" class="primary-btn">Comprar agora <span class="arrow_right"></span></a>
                            <div class="hero__social">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
        ...
        <div class="hero__items set-bg" data-setbg="{{asset('site/img/hero/hero-3.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
