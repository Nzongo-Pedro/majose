<div class="section-menu-left">
    <div class="box-logo">
        <a href="/" id="site-logo-inner">
            <img class="" id="logo_header" alt="{{env('APP_NAME')}}" src="{{asset('dashboard/images/logo/logo.png')}}"
                data-light="{{asset('dashboard/images/logo/logo.png"')}}' data-dark="
                {{asset('dashboard/images/logo/logo-dark.png')}}">
        </a>
    ...
    <div class="section-menu-left-wrap">
        <div class="center">
            <div class="center-item">
                <div class="center-heading">Página Inicial</div>
                <ul class="menu-list">
            ...
            <div class="center-item">
                <div class="center-heading">Páginas</div>
                <ul class="menu-list">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="category-list.html" class="">
                                    <div class="text">Listar categoria</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                    ...
                    <li class="menu-item has-children">
                        <a href="javascript:void(0);" class="menu-item-button">
                            ...
                            <div class="text">Atributos</div>
                        </a>
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="attributes.html" class="">
                                    <div class="text">Listar atributos</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="add-attributes.html" class="">
                                    <div class="text">Adicionar atributos</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="all-user.html" class="">
                                    <div class="text">Todos Usuários</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="add-new-user.html" class="">
                                    <div class="text">Adicionar Usuários</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
