                                                    ...
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                            <a href="product-list.html"
                                                                class="body-title-2 mb-3">Pedigree Adult Dry
                                                                Dog...</a>
                                        ...
                                        <ul class="flex flex-column gap20 overflow-h">
                                            ...
                                            <li class="comment-item">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="text-tiny">Cras nec viverra justo, a mattis lacus.
                                                        Vestibulum eleifend, leo sit amet aliquam laoreet, turpis
                                                        leo
                                                        vulputate orci</div>
                                                </div>
                                            </li>
                                            <li class="comment-item">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="text-tiny">Morbi eget commodo diam. Praesent
                                                        dignissim
                                            ...
                                            <li class="comment-item">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="text-tiny">Phasellus et eros ullamcorper, efficitur
                                                        eros
                                                        eget, pharetra ante. Sed blandit risus vitae dolor feugiat,
                                                        eu
